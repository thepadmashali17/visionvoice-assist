...
git clone https://github.com/your-username/VisionVoice-Assist.git\
cd VisionVoice-Assist
...
Developed as an AI-based assistive technology project using YOLOv5 and
Python.
